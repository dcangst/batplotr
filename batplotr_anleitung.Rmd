...
```{r nightPlot Beispiel, fig.cap="Figure 2: Beispiel eines `nightPlots` mit vielen Optionen",cache=TRUE}
    daten_sum_StO1 <- subset(daten_sum,ProjectName==unique(daten_sum$ProjectName)[4])
    nightPlot(daten_sum, day=c("2014-08-23","2014-08-24"),sel_species=unique(daten_sum_StO1$species)[c(1,2,4)], x_limits=as.POSIXct(c("2014-08-23 16:00","2014-08-25 10:00")), y_limits=c(0,12),plot_T=FALSE)
```
